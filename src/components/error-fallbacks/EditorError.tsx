...
export function EditorError({ onReset }: EditorErrorProps) {
  return (
    <div className="flex flex-col items-center justify-center h-full min-h-[200px] p-6 bg-destructive/5 rounded-lg border border-destructive/20">
      ...
      <h2 className="text-base font-semibold text-foreground mb-2">Editor Error</h2>
      <p className="text-sm text-muted-foreground mb-4 text-center max-w-sm">
        The code editor encountered an error. Your code has been preserved.
      </p>
